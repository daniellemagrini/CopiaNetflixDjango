...
AUTH_USER_MODEL = "filme.Usuario" # filme é o nome do app e Usuario é a classe
...
LOGIN_REDIRECT_URL = 'filme:homefilmes' # Página para onde o usuário será redirecionado depois de fazer o login

LOGIN_URL = 'filme:login' # Página onde o usuário irá fazer o login # Essefilme: é o mesmo do namespace que passou
